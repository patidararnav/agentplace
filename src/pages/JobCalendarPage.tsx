      ...
      <header className="px-6 py-4 flex-shrink-0 border-b border-border/40">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">{mockPlannedJobs.length} upcoming</p>
          </div>
        </div>
      </header>
          ...
          <div className="grid grid-cols-7 gap-1">
            {days.map((d, i) => {
              ...
              return (
                ...
                >
                  <span className={cn('text-sm', isToday(d) ? 'font-bold text-primary' : 'text-muted-foreground')}>{d}</span>
